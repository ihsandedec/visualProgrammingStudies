...
namespace sayfa78_Koordinat_Boyut01
{
    public partial class Form1 : Form
    {
        ...
        private void numericUpDown_ust_ValueChanged_1(object sender, EventArgs e)
        {
            textBox1.Top = (int)numericUpDown_ust.Value;
        }

        private void numericUpDown_genislik_ValueChanged_1(object sender, EventArgs e)
        {
            textBox1.Width = (int)numericUpDown_genislik.Value;
        }

        private void numericUpDown_yukseklik_ValueChanged_1(object sender, EventArgs e)
        {
